i want to make a similar form that below provided so the name of the file is add_Subject.php so this file can be usd to edit the details of the card that contain the arttribute(subject, iimage, 
<?php
session_start();
